"""
Dinner Bot - Telegram Notifier
Sends meal recommendations to Telegram
"""
import asyncio
...
class TelegramNotifier:
    ...
    async def send_meal(self, menu: str) -> bool:
        """
        식단 메시지 발송
        ...
        Args:
            menu: 생성된 식단 텍스트
        """
        return await self.send_message(menu, parse_mode="Markdown")
...
async def test_notifier():
    ...
    if notifier.bot:
        result = await notifier.send_message("🧪 저녁식단 추천봇 테스트 메시지입니다!")
